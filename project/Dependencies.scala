...
object Dependencies {
  ...
  private val allocationInstrumenter =
  ...
  val benchmarks = common ++ dependencies(
    googleGuava,
    googleFindbugs,
    breeze,
    breezeNatives,
  ...
  private def dependencies(modules: ModuleID*): Seq[Setting[_]] =
    Seq(libraryDependencies ++= modules)
}
