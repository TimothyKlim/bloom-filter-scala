...
object CanGenerate128HashFrom {
  ...
  implicit case object CanGenerate128HashFromByteArray
      extends CanGenerate128HashFrom[Array[Byte]] {
    override def generateHash(from: Array[Byte]): (Long, Long) =
      MurmurHash3Generic.murmurhash3_x64_128(from, 0, from.length, 0)
  }

  implicit case object CanGenerate128HashFromString
      extends CanGenerate128HashFrom[String] {
  ...
  implicit case object CanGenerate128HashFromLong
      extends CanGenerate128HashFrom[Long] {
